...
do {
    ...
    switch (choice) {
        case "1": {
            let category = prompt("Nhập tên danh mục:"); // Nhập tên danh mục để thêm món ăn
            ...
            menu[category].push({ // Thêm món ăn vào danh mục
                name: dishName,
                price: price,
        ...
        case "2": {
            let category = prompt("Nhập tên danh mục:"); // Nhập tên danh mục để xóa món ăn
        ...
        case "3": {
            let category = prompt("Nhập tên danh mục:"); // Nhập tên danh mục để cập nhật món ăn
        ...
        case "4": {
            if (Object.keys(menu).length === 0) { // Kiểm tra xem menu có rỗng không
                alert("Menu trống.");
            } else {
